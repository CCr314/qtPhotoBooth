...
QT_MOC_LITERAL(1, 10, 9), // "takePhoto"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 19), // "on_btnStart_clicked"
QT_MOC_LITERAL(4, 41, 21), // "mouseDoubleClickEvent"
QT_MOC_LITERAL(5, 63, 12), // "QMouseEvent*"
QT_MOC_LITERAL(6, 76, 5), // "event"
QT_MOC_LITERAL(7, 82, 15) // "mousePressEvent"

    },
    "Commandes\0takePhoto\0\0on_btnStart_clicked\0"
    "mouseDoubleClickEvent\0QMouseEvent*\0"
    "event\0mousePressEvent"
};
...
void Commandes::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Commandes *_t = static_cast<Commandes *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (Commandes::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Commandes::takePhoto)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Commandes::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Commandes.data,
      qt_meta_data_Commandes,  qt_static_metacall, nullptr, nullptr}
};
